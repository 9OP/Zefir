...
const Card: FC<{ className?: string }> = ({ children, className }) => (
  <div
    className={`bg-gray-50 border border-gray-300 rounded-lg shadow-xl ${
      className || ''
    }`}
  >
...
const Header: FC<{ onClose?: () => void }> = ({ children, onClose }) => (
...
export const Modal: FC<{
  ...
  onClose?: () => void;
  title?: ReactNode;
}> = ({ children, isVisible, onClose, title }) => (
  <div
    className={`${
  ...
  >
    ...
    <Card className="z-50 w-4/12 mx-auto overflow-y-auto">
